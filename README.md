...
| `labelWidth`                                    | The width of the picker label or of each picker labbel if multiple pickers are specified. The default value is 0. The width value must conform to `width` property values.                                                                                                                                                                                                                                                                                                                                                                                                | array
...
| `valueToString(selectedItem)`<br>               | A function to return the formatted picker value label as a string. _                                                                                                                                                                                                                                                                                                                                                                                  | function                 |
...
-   Other styles that can be modified for iOS are named `inputIOSContainer`, `placeholder`, `viewContainer`, `pickerContainer`, `chevronContainer`, `chevron`, `chevronUp`, `chevronDown`, `chevronActive`, `done`, `modalViewTop`, `modalViewMiddle`, and `modalViewBottom`
...
-   Other styles that can be modified for Android are named `headlessAndroidContainer`, `viewContainer` and `pickerContainer`
